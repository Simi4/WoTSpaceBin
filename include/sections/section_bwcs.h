 ...
 *
 * The space settings is small amount of meta data which describes the space as
 * a whole
 */
class SectionBWCS : public SectionBase {
 ...
 private:
  ...
  /**
   * The spaceBounds should contain the entire bounds of all objects in the
   * space (including "out-land" items that may not originally fall inside the
   * terrain region).
   */
  Bbox _spaceBounds;
};
