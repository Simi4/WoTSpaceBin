...
/**
 * Contains the information representing a material, including effect and
 * properties to set.
 */
...
/**
 * Contains the matrix for a shader property so it only needs to be referenced
 * by index.
 */
...
/**
 * Contains the vector data for a shader property so it only needs to be
 * referenced by index.
 */
